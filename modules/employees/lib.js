...
EmployeeAdapter.method('getFormFields', function() {
	return [
	        ...
	        [ "ssn_num", {"label":"National ID","type":"text","validation":"none"}],
	        [ "nic_num", {"label":"Insurance ID","type":"text","validation":"none"}],
	        [ "other_id", {"label":"Syndicate ID","type":"text","validation":"none"}],
